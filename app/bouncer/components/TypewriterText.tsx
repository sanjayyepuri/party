...
export default function TypewriterText({ 
  ...
  useEffect(() => {
    ...
    if (currentCharIndex < currentLine.length) {
      ...
      }, mergedConfig.baseTypingSpeed + Math.random() * mergedConfig.typingSpeedVariation);
  ...
  }, [currentLineIndex, currentCharIndex, lines, currentLine, isLastLine, mergedConfig, onComplete, isComplete]);
